  ...
  describe('--view <engine>', function () {
    describe('hbs', function () {
      ...
      it('should have hbs in package dependencies', function () {
        ...
        ok(typeof dependencies.hbs === 'string')
      })

      it('should have hbs templates', function () {
        notStrictEqual(ctx.files.indexOf('views/error.hbs'), -1)
        notStrictEqual(ctx.files.indexOf('views/index.hbs'), -1)
        notStrictEqual(ctx.files.indexOf('views/layout.hbs'), -1)
      })
