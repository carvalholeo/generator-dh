  ...
  describe('--view <engine>', function () {
    describe('vash', function () {
      ...
      it('should have vash in package dependencies', function () {
        ...
        ok(typeof dependencies.vash === 'string')
      })

      it('should have vash templates', function () {
        notStrictEqual(ctx.files.indexOf('views/error.vash'), -1)
        notStrictEqual(ctx.files.indexOf('views/index.vash'), -1)
        notStrictEqual(ctx.files.indexOf('views/layout.vash'), -1)
      })
