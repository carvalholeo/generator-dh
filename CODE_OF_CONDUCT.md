...
Ocorrências de comportamentos abusivos, de assédio ou que sejam inaceitáveis por qualquer outro motivo poderão ser reportadas para a liderança da comunidade, responsável pela aplicação, via e-mail, para [leo@leocarvalho.dev](mailto:leo@leocarvalho.dev) ou no canal `#chat` no [servidor do Discord](https://discord.gg/QFbX5skKhc), pedindo para que algum dos administradores converse com você em particular.
